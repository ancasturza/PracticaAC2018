...
namespace ClassroomTrivia.LessonOne.Controllers
{
    public class QuestionsController : Controller
    {
        private readonly ClassroomTriviaContext _context;

        public QuestionsController(ClassroomTriviaContext context)
        {
            _context = context;
        }
