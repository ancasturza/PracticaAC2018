...
namespace ClassroomTrivia.Controllers
{
    ...
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var question = await _context.Question.Include("Answers")
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var question = await _context.Question.Include("Answers").SingleOrDefaultAsync(m => m.QuestionId == id);
            if (question == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("QuestionId,Text,Answers")] Question question)
        {
